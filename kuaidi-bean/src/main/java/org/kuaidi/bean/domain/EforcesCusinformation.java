...
public class EforcesCusinformation implements Serializable{
    /**
	 * 
	 */
	private static final long serialVersionUID = 4535567822737064999L;
	...
	public String toString() {
		return "EforcesCusinformation [id=" + id + ", guestid=" + guestid + ", guestname=" + guestname
				+ ", isfisweight=" + isfisweight + ", userid=" + userid + ", username=" + username + ", costtype="
				+ costtype + ", calcumethod=" + calcumethod + ", goodtype=" + goodtype + ", paytype=" + paytype
				+ ", operatpay=" + operatpay + ", discount=" + discount + ", transporttype=" + transporttype
				+ ", carrierid=" + carrierid + ", carriername=" + carriername + ", fisweight=" + fisweight + ", fwpay="
				+ fwpay + ", isfell=" + isfell + ", fisnum=" + fisnum + ", starwei1=" + starwei1 + ", endwei1="
				+ endwei1 + ", isfell1=" + isfell1 + ", danwei1=" + danwei1 + ", starwei2=" + starwei2 + ", endwei2="
				+ endwei2 + ", isfell2=" + isfell2 + ", danwei2=" + danwei2 + ", starwei3=" + starwei3 + ", endwei3="
				+ endwei3 + ", isfell3=" + isfell3 + ", danwei3=" + danwei3 + ", starwei4=" + starwei4 + ", endwei4="
				+ endwei4 + ", isfell4=" + isfell4 + ", danwei4=" + danwei4 + ", starwei5=" + starwei5 + ", endwei5="
				+ endwei5 + ", isfell5=" + isfell5 + ", danwei5=" + danwei5 + ", starwei6=" + starwei6 + ", endwei6="
				+ endwei6 + ", isfell6=" + isfell6 + ", danwei6=" + danwei6 + ", starwei7=" + starwei7 + ", endwei7="
				+ endwei7 + ", isfell7=" + isfell7 + ", danwei7=" + danwei7 + ", starwei8=" + starwei8 + ", endwei8="
				+ endwei8 + ", isfell8=" + isfell8 + ", danwei8=" + danwei8 + ", startime=" + startime + ", endtime="
				+ endtime + ", incnumber=" + incnumber + ", incname=" + incname + ", weighttype=" + weighttype
				+ ", jinse=" + jinse + ", xuweight=" + xuweight + ", fenjd1=" + fenjd1 + ", fenjd2=" + fenjd2
				+ ", createid=" + createid + ", createname=" + createname + ", createtime=" + createtime
				+ ", recipientid=" + recipientid + ", recipientname=" + recipientname + ", remarks=" + remarks + "]";
	}
