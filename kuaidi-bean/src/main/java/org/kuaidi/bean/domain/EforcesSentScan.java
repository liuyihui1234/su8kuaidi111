...
public class EforcesSentScan implements Serializable ,Cloneable {
	...
	@Override
	public EforcesSentScan clone() throws CloneNotSupportedException {
		// TODO Auto-generated method stub
		return (EforcesSentScan)super.clone();
	}
