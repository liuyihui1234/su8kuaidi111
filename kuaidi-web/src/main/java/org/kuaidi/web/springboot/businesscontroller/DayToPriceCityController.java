 ...
 */
@RestController
@RequestMapping("/web/dayToPriceCity/")
public class DayToPriceCityController {
    ...
    public ResultVo getOrderShow(HttpServletRequest request ,String startTime , String endTime){
   	 try {
   		 ...
   		 List<Map<String, Object>> list = orderService.getDayToPriceByCity(incment.getNumber(), startTime, endTime);
    ...
    public void outExcelOrderShow(HttpServletResponse response, String incId,
      	 ...
      	 try {
      		 ...
      		 List<Map<String, Object>> list = orderService.getDayToPriceByCity(incNum, startTime, endTime);
      		 String[] header = {"城市编号", "城市名字","寄方付","收方付","月结",  "代收货款"};
               //声明一个工作簿
               HSSFWorkbook workbook = new HSSFWorkbook();
               //生成一个表格，设置表格名称为"学生表"
               HSSFSheet sheet = workbook.createSheet("每日营业统计(按城市)");
               //设置表格列宽度为10个字节
               ...
               if(list != null && list.size() > 0 ) {
              	 for(int i = 0 ; i < list.size() ; i++) {
              		 ...
              		 if(rectoOrderItem != null ) {
              			 ...
              			 String  createincnumber = (String)rectoOrderItem.get("cityid");
                         ...
                         cell = row.createCell(1);
               			 String  createincname = (String)rectoOrderItem.get("cityname");
               ...
               //这后面可以设置导出Excel的名称，
               String fileName = "dayToPriceCity" +  TimeDayUtil.getCurrentDate() + ".xls";
